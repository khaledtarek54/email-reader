...
(function (factory) {
    ...
    function DateTimePicker(element, options) {
        ...
        var sLanguage = "";
        sLanguage =
            $.cf._isValid(options) && $.cf._isValid(options.language)
                ? options.language
                : $.DateTimePicker.defaults.language;
        this.settings = $.extend(
            {},
            $.DateTimePicker.defaults,
            $.DateTimePicker.i18n[sLanguage],
            options
        );
                    ...
                    if (sArrDataKeys.length > 0) {
                        for (iKey in sArrDataKeys) {
                            ...
                            if (sKey.search("plugin_DateTimePicker") !== -1) {
                                $(document).unbind(
                                    "click.DateTimePicker keydown.DateTimePicker keyup.DateTimePicker"
                                );
                                ...
                                $(this).unbind();
                                $(this).removeClass(
                                    "dtpicker-overlay dtpicker-mobile dtpicker-inline"
                                );
                        ...
                        console.log(
                            "No DateTimePicker Object Defined For This Element"
                        );
                    }
    ...
    DateTimePicker.prototype = {
        ...
        init: function () {
            ...
            if ($(oDTP.element).data("parentelement") !== undefined) {
                oDTP.settings.parentElement = $(oDTP.element).data(
                    "parentelement"
                );
            }
        ...
        _setTimeFormatArray: function () {
            ...
            sTime =
                "hh" +
                oDTP.settings.timeSeparator +
                "mm" +
                oDTP.settings.timeSeparator +
                "ss" +
                oDTP.settings.timeMeridiemSeparator +
                "AA";
        ...
        _addEventHandlersForInput: function () {
            ...
            if (!oDTP.settings.isInline) {
                ...
                var sel =
                    "[data-field='date'], [data-field='time'], [data-field='datetime']";
                $(oDTP.settings.parentElement)
                    .off("focus", sel, oDTP._inputFieldFocus)
                    .on("focus", sel, { obj: oDTP }, oDTP._inputFieldFocus);

                $(oDTP.settings.parentElement)
                    .off("click", sel, oDTP._inputFieldClick)
        ...
        getDateObjectForInputField: function (oInputField) {
            ...
            if ($.cf._isValid(oInputField)) {
                ...
                if (!oDTP.settings.formatDateTimeString) {
                    ...
                    dInput = oDTP.settings.parseDateTimeString.call(
                        oDTP,
                        sDateTime,
                        sMode,
                        sFormat,
        ...
        setDateTimeStringInInputField: function (oInputField, dInput) {
            ...
            if ($.cf._isValid(oInputField)) {
                ...
                if ($.cf._isValid(oDTP.settings.parentElement)) {
                    oArrElements = $(oDTP.settings.parentElement).find(
                        "[data-field='date'], [data-field='time'], [data-field='datetime']"
                    );
                } else {
                    oArrElements = $(
        ...
        getDateTimeStringInFormat: function (sMode, sFormat, dInput) {
            var oDTP = this;
            return oDTP._setOutput(
                sMode,
                sFormat,
                oDTP.getIs12Hour(sMode, sFormat),
                dInput
            );
        },
            ...
            if (oDTP.oData.oInputElement !== null) {
                ...
                if (bFromTab) {
                    if (oDTP.settings.buttonClicked)
                        oDTP.settings.buttonClicked.call(
                            oDTP,
                            "TAB",
                            oDTP.oData.oInputElement
                        );
        ...
        _setOutput: function (
            ...
            dCurrentDate = $.cf._isValid(dCurrentDate)
                ? dCurrentDate
            ...
            if (oDTP.settings.formatDateTimeString) {
                sOutput = oDTP.settings.formatDateTimeString.call(
                    oDTP,
                    oFDT,
                    sMode,
                    sFormat,
                ...
                if (oDTP.oData.bDateMode) {
                    if (oDTP.oData.bArrMatchFormat[0]) {
                        ...
                        sOutput =
                            oFDT.MM +
                            oDTP.settings.monthYearSeparator +
                            oFDT.yyyy;
                    ...
                    if (oDTP.oData.bArrMatchFormat[0]) {
                        ...
                        sOutput =
                            oFDT.HH + oDTP.settings.timeSeparator + oFDT.mm;
                    }
                    ...
                    if (sDateStr !== "" && sTimeStr !== "")
                        sOutput =
                            sDateStr +
                            oDTP.settings.dateTimeSeparator +
                            sTimeStr;
                }
        ...
        _setOutputOnIncrementOrDecrement: function () {
            ...
            if (
                $.cf._isValid(oDTP.oData.oInputElement) &&
                oDTP.settings.setValueInTextboxOnEveryClick
            ) {
                oDTP._setValueOfElement(oDTP._setOutput());
            }
        },
        ...
        _showPicker: function (oElement) {
            ...
            if (oDTP.oData.oInputElement === null) {
                ...
                if (!oDTP.settings.isPopup && !oDTP.settings.isInline) {
                    ...
                    var iElemTop =
                            $(oDTP.oData.oInputElement).offset().top +
                            $(oDTP.oData.oInputElement).outerHeight(),
                ...
                if (oDTP.oData.bDateMode) {
                    ...
                    if (
                        sStartEnd !== "" &&
                        ($.cf._compare(sStartEnd, "start") ||
                            $.cf._compare(sStartEnd, "end")) &&
                        sStartEndElem !== ""
                    ) {
                        if ($(sStartEndElem).length >= 1) {
                            sTempDate = oDTP._getValueOfElement(
                                $(sStartEndElem)
                            );
                            if (sTempDate !== "") {
                                if (oDTP.settings.parseDateTimeString)
                                    dTempDate =
                                        oDTP.settings.parseDateTimeString.call(
                                            oDTP,
                                            sTempDate,
                                            sMode,
                                            sFormat,
                                ...
                                if ($.cf._compare(sStartEnd, "start")) {
                                    if ($.cf._isValid(sMax)) {
                                        if (
                                            oDTP._compareDates(
                                                dTempDate,
                                                oDTP.oData.dMaxValue
                                            ) < 0
                                        )
                                            oDTP.oData.dMaxValue = new Date(
                                                dTempDate
                                            );
                                    } else
                                        oDTP.oData.dMaxValue = new Date(
                                    ...
                                    if ($.cf._isValid(sMin)) {
                                        if (
                                            oDTP._compareDates(
                                                dTempDate,
                                                oDTP.oData.dMinValue
                                            ) > 0
                                        )
                                            oDTP.oData.dMinValue = new Date(
                                                dTempDate
                                            );
                                    } else
                                        oDTP.oData.dMinValue = new Date(
                    ...
                    if ($.cf._isValid(sMin)) {
                        ...
                        if (!$.cf._isValid(sMax)) {
                            if (
                                oDTP.oData.sTimeFormat ===
                                oDTP.oData.sArrInputTimeFormats[0]
                            )
                                sMax = "11:59:59 PM";
                            else if (
                                oDTP.oData.sTimeFormat ===
                                oDTP.oData.sArrInputTimeFormats[1]
                            )
                                sMax = "23:59:59";
                            else if (
                                oDTP.oData.sTimeFormat ===
                                oDTP.oData.sArrInputTimeFormats[2]
                            )
                                sMax = "11:59 PM";
                            else if (
                                oDTP.oData.sTimeFormat ===
                                oDTP.oData.sArrInputTimeFormats[3]
                            )
                                sMax = "23:59";
                    ...
                    if (
                        ...
                        if ($(sStartEndElem).length >= 1) {
                            sTempTime = oDTP._getValueOfElement(
                                $(sStartEndElem)
                            );
                            if (sTempTime !== "") {
                                if (oDTP.settings.parseDateTimeString)
                                ...
                                if ($.cf._compare(sStartEnd, "start")) {
                                    dTempTime.setMinutes(
                                        dTempTime.getMinutes() - 1
                                    );
                                    if ($.cf._isValid(sMax)) {
                                        if (
                                            oDTP._compareTime(
                    ...
                    if (
                        ...
                        if ($(sStartEndElem).length >= 1) {
                            sTempDateTime = oDTP._getValueOfElement(
                                $(sStartEndElem)
                            );
                            if (sTempDateTime !== "") {
                                if (oDTP.settings.parseDateTimeString)
                                    ...
                                    dTempDateTime =
                                        oDTP._parseDateTime(sTempDateTime);

                                if ($.cf._compare(sStartEnd, "start")) {
                                    if ($.cf._isValid(sMax)) {
                                        if (
                                            oDTP._compareDateTime(
                                                dTempDateTime,
                                                oDTP.oData.dMaxValue
                                            ) < 0
                                        )
        ...
        _modifyPicker: function () {
            ...
            for (
                iTempIndex = 0;
                iTempIndex < oDTP.settings.buttonsToDisplay.length;
                iTempIndex++
            ) {
                if (
                    $.cf._compare(
                        oDTP.settings.buttonsToDisplay[iTempIndex],
                        "HeaderCloseButton"
                    )
                )
            ...
            var sHeader = "";
			let deliveryDateTimezone = null;
            if (oDTP.settings.showHeader) {
                sHeader += "<div class='dtpicker-header'>";
                sHeader +=
                    "<div class='dtpicker-title'>" + sTitleContent + "</div>";
                if (bDisplayHeaderCloseButton)
                    sHeader += "<a class='dtpicker-close'>&times;</a>";
                sHeader += "<div class='dtpicker-value'></div>";
                sHeader +=
    					"<select id='timezoneSelector' class='dtpicker-timezone' " +
    					"style=' height: 2.5em; text-align: center; display: block; margin: 0 auto;'>";
                if (window.timezones && Array.isArray(window.timezones)) {
                    window.timezones.forEach(function (tz) {
                        sHeader += `<option style='text-align: left;' value="${tz.timezone}">${tz.name} (${tz.timezone})</option>`;
                    });
                }
                sHeader += "</select>";
                sHeader += "</div>";
				document.addEventListener("change", function (event) {
					if (event.target && event.target.id === "timezoneSelector") {
						document.getElementById("deliveryDateTimezone").value = event.target.value;
					}
				});
            }
            ...
            for (iTempIndex = 0; iTempIndex < iNumberOfColumns; iTempIndex++) {
                ...
                sDTPickerComp +=
                    "<div class='dtpicker-compOutline " + sColumnClass + "'>";
                sDTPickerComp +=
                    "<div class='dtpicker-comp " + sFieldName + "'>";
                sDTPickerComp +=
                    "<a class='dtpicker-compButton increment'>" +
                    oDTP.settings.incrementButtonContent +
                    "</a>";
                if (oDTP.settings.readonlyInputs)
                    sDTPickerComp +=
                        "<input type='text' class='dtpicker-compValue' readonly>";
                else
                    sDTPickerComp +=
                        "<input type='text' class='dtpicker-compValue'>";
                sDTPickerComp +=
                    "<a class='dtpicker-compButton decrement'>" +
                    oDTP.settings.decrementButtonContent +
                    "</a>";
                if (oDTP.settings.labels)
                    sDTPickerComp +=
                        "<div class='dtpicker-label'>" +
            ...
            sDTPickerButtons +=
                "<div class='dtpicker-buttonCont" + sButtonContClass + "'>";
            if (bDisplaySetButton)
                sDTPickerButtons +=
                    "<a class='dtpicker-button dtpicker-buttonSet'>" +
                    oDTP.settings.setButtonContent +
                    "</a>";
            if (bDisplayClearButton)
                sDTPickerButtons +=
                    "<a class='dtpicker-button dtpicker-buttonClear'>" +
                    oDTP.settings.clearButtonContent +
                    "</a>";
        ...
        _addEventHandlersForPicker: function () {
            ...
            $(document).on("keydown.DateTimePicker", function (e) {
                ...
                if (!$(".dtpicker-compValue").is(":focus") && keyCode === 9) {
                    ...
                    if (keyCode === 38) {
                        // Up Arrow
                        classType = $(".dtpicker-compValue:focus")
                            .parent()
                            .attr("class");
                        oDTP._incrementDecrementActionsUsingArrowAndMouse(
                            classType,
                            "inc"
                        );
                        return false;
            ...
            if (!oDTP.settings.readonlyInputs) {
                $(".dtpicker-compValue")
                    .not(
                        ".month .dtpicker-compValue, .meridiem .dtpicker-compValue"
                    )
                    .keyup(function () {
                ...
                $(".dtpicker-compValue").blur(function () {
                    ...
                    setTimeout(function () {
                        if (
                            $oParentElem.is(":last-child") &&
                            !oDTP.oData.bElemFocused
                        ) {
            ...
            $(oDTP.element)
                ...
                .on("mousewheel DOMMouseScroll onmousewheel", function (e) {
                    if ($(".dtpicker-compValue").is(":focus")) {
                        var delta = Math.max(
                            -1,
                            Math.min(1, e.originalEvent.wheelDelta)
                        );
            ...
            if (
                oDTP.settings.captureTouchHold ||
                oDTP.settings.captureMouseHold
            ) {
                var sHoldEvents = "";
            ...
            $(oDTP.element)
                .find(
                    ".meridiem .dtpicker-compButton, .meridiem .dtpicker-compButton *"
                )
                .click(function (e) {
                    if ($.cf._compare(oDTP.oData.sCurrentMeridiem, "AM")) {
                        ...
                        $.cf._compare(oDTP.oData.sCurrentMeridiem, "PM")
                    ) {
        ...
        _adjustMinutes: function (iMinutes) {
            var oDTP = this;
            if (
                oDTP.settings.roundOffMinutes &&
                oDTP.settings.minuteInterval !== 1
            ) {
                iMinutes =
                    iMinutes % oDTP.settings.minuteInterval
                        ? iMinutes -
                          (iMinutes % oDTP.settings.minuteInterval) +
                          oDTP.settings.minuteInterval
                        : iMinutes;
        ...
        _adjustSeconds: function (iSeconds) {
            var oDTP = this;
            if (
                oDTP.settings.roundOffSeconds &&
                oDTP.settings.secondsInterval !== 1
            ) {
                iSeconds =
                    iSeconds % oDTP.settings.secondsInterval
                        ? iSeconds -
                          (iSeconds % oDTP.settings.secondsInterval) +
                          oDTP.settings.secondsInterval
                        : iSeconds;
        ...
        _setValueOfElement: function (sElemValue, $oElem) {
            ...
            if (oDTP.settings.settingValueOfElement)
                oDTP.settings.settingValueOfElement.call(
                    oDTP,
                    sElemValue,
                    dElemValue,
                    $oElem
        ...
        _setIntervalForTouchEvents: function () {
            ...
            var iInterval = oDTP.oData.bIsTouchDevice
                ? oDTP.settings.touchHoldInterval
                : oDTP.settings.mouseHoldInterval;
            if (!$.cf._isValid(oDTP.oData.oTimeInterval)) {
                ...
                oDTP.oData.oTimeInterval = setInterval(function () {
                    ...
                    if (
                        iDiff > iInterval &&
                        $.cf._isValid(oDTP.oData.sTouchButton)
                    ) {
        ...
        _parseDate: function (sDate) {
            ...
            var dTempDate = oDTP.settings.defaultDate
                    ? new Date(oDTP.settings.defaultDate)
                    : new Date(),
            ...
            if ($.cf._isValid(sTime)) {
                if (typeof sTime === "string") {
                    if (oDTP.oData.bIs12Hour) {
                        ...
                        if (
                            !(
                                $.cf._compare(sMeridiem, "AM") ||
                                $.cf._compare(sMeridiem, "PM")
                            )
                        )
                            sMeridiem = "";
                    }
                    ...
                    if ($.cf._isValid(sTime)) {
                        if (oDTP.oData.bIs12Hour) {
                            if (
                                ...
                                sArrDateTime.length === 3
                            )
                                sMeridiem = sArrDateTime[2];
                            else {
                                sArrTimeComp = sTime.split(
                                    oDTP.settings.timeMeridiemSeparator
                                );
        ...
        _getShortMonthIndex: function (sMonthName) {
            ...
            for (
                var iTempIndex = 0;
                iTempIndex < oDTP.settings.shortMonthNames.length;
                iTempIndex++
            ) {
                if (
                    $.cf._compare(
                        sMonthName,
                        oDTP.settings.shortMonthNames[iTempIndex]
                    )
                )
                    return iTempIndex;
            }
        ...
        _getFullMonthIndex: function (sMonthName) {
            ...
            for (
                var iTempIndex = 0;
                iTempIndex < oDTP.settings.fullMonthNames.length;
                iTempIndex++
            ) {
                if (
                    $.cf._compare(
                        sMonthName,
                        oDTP.settings.fullMonthNames[iTempIndex]
                    )
                )
                    return iTempIndex;
            }
        ...
        _setVariablesForDate: function (dInput, bIncludeTime, bSetMeridiem) {
            ...
            if (bValidInput) {
                ...
                if (
                    Object.prototype.toString.call(oDTP.oData.dCurrentDate) ===
                        "[object Date]" &&
                    isFinite(oDTP.oData.dCurrentDate)
                )
                ...
                if (!$.cf._isValid(bIncludeTime))
                    bIncludeTime =
                        oDTP.oData.bTimeMode || oDTP.oData.bDateTimeMode;
            ...
            if (bIncludeTime) {
                ...
                if (bSetMeridiem) {
                    oDTV.sCurrentMeridiem =
                        oDTP._determineMeridiemFromHourAndMinutes(
                            oDTV.iCurrentHour,
                            oDTV.iCurrentMinutes
                        );
                }
            }
        ...
        _getValuesFromInputBoxes: function () {
            ...
            if (oDTP.oData.bDateMode || oDTP.oData.bDateTimeMode) {
                ...
                oDTP.oData.iCurrentDay =
                    parseInt(
                        $(oDTP.element).find(".day .dtpicker-compValue").val()
                    ) || oDTP.oData.iCurrentDay;
                oDTP.oData.iCurrentYear =
                    parseInt(
                        $(oDTP.element).find(".year .dtpicker-compValue").val()
                    ) || oDTP.oData.iCurrentYear;
            }
            ...
            if (oDTP.oData.bTimeMode || oDTP.oData.bDateTimeMode) {
                ...
                iTempHour = parseInt(
                    $(oDTP.element).find(".hour .dtpicker-compValue").val()
                );
                iTempMinutes = oDTP._adjustMinutes(
                    parseInt(
                        $(oDTP.element)
                            .find(".minutes .dtpicker-compValue")
                            .val()
                    )
                );
                iTempSeconds = oDTP._adjustMinutes(
                    parseInt(
                        $(oDTP.element)
                            .find(".seconds .dtpicker-compValue")
                            .val()
                    )
                );

                oDTP.oData.iCurrentHour = isNaN(iTempHour)
                    ? oDTP.oData.iCurrentHour
                    : iTempHour;
                oDTP.oData.iCurrentMinutes = isNaN(iTempMinutes)
                    ? oDTP.oData.iCurrentMinutes
                    : iTempMinutes;
                oDTP.oData.iCurrentSeconds = isNaN(iTempSeconds)
                    ? oDTP.oData.iCurrentSeconds
                    : iTempSeconds;
                ...
                if (oDTP.oData.bIs12Hour) {
                    sMeridiem = $(oDTP.element)
                        .find(".meridiem .dtpicker-compValue")
                        .val();
                    if (
                        $.cf._compare(sMeridiem, "AM") ||
                        $.cf._compare(sMeridiem, "PM")
                    ...
                    if ($.cf._compare(oDTP.oData.sCurrentMeridiem, "PM")) {
                        if (
                            oDTP.oData.iCurrentHour !== 12 &&
                            oDTP.oData.iCurrentHour < 13
                        )
                            oDTP.oData.iCurrentHour += 12;
                    }
                    if (
                        $.cf._compare(oDTP.oData.sCurrentMeridiem, "AM") &&
                        oDTP.oData.iCurrentHour === 12
                    )
        ...
        _setCurrentDate: function () {
            ...
            if (oDTP.oData.bTimeMode || oDTP.oData.bDateTimeMode) {
                ...
                oDTP.oData.iCurrentMinutes = oDTP._adjustMinutes(
                    oDTP.oData.iCurrentMinutes
                );
                oDTP.oData.iCurrentSeconds = oDTP._adjustSeconds(
                    oDTP.oData.iCurrentSeconds
                );
            }
            ...
            if (oDTP.oData.dMaxValue !== null)
                bGTMaxDate =
                    dTempDate.getTime() > oDTP.oData.dMaxValue.getTime();
            if (oDTP.oData.dMinValue !== null)
                bLTMinDate =
                    dTempDate.getTime() < oDTP.oData.dMinValue.getTime();
            ...
            if (bGTMaxDate || bLTMinDate) {
                ...
                if (oDTP.oData.dMaxValue !== null)
                    bCDGTMaxDate =
                        oDTP.oData.dCurrentDate.getTime() >
                        oDTP.oData.dMaxValue.getTime();
                if (oDTP.oData.dMinValue !== null)
                    bCDLTMinDate =
                        oDTP.oData.dCurrentDate.getTime() <
                        oDTP.oData.dMinValue.getTime();
                ...
                if (!(bCDGTMaxDate || bCDLTMinDate))
                    ...
                    if (bCDGTMaxDate) {
                        ...
                        console.log(
                            "Info : Date/Time/DateTime you entered is later than Maximum value, so DateTimePicker is showing Maximum value in Input Field."
                        );
                    }
                    if (bCDLTMinDate) {
                        dTempDate = new Date(oDTP.oData.dMinValue);
                        console.log(
                            "Info : Date/Time/DateTime you entered is earlier than Minimum value, so DateTimePicker is showing Minimum value in Input Field."
                        );
                    }
                    console.log(
                        "Please enter proper Date/Time/DateTime values."
                    );
                }
            }
            ...
            if (oDTP.oData.bDateMode || oDTP.oData.bDateTimeMode) {
                ...
                $(oDTP.element)
                    .find(".day .dtpicker-compValue")
                    .val(oFormattedDate.dd);
                ...
                if (oDTP.oData.bDateMode) {
                    if (
                        ...
                        $(oDTP.element)
                            .find(".month .dtpicker-compValue")
                            .val(oFormattedDate.MM);
                    else if (oDTP.oData.bArrMatchFormat[6])
                        // "MMMM yyyy"
                        $(oDTP.element)
                            .find(".month .dtpicker-compValue")
                            .val(oFormattedDate.month);
                    else
                        $(oDTP.element)
                            .find(".month .dtpicker-compValue")
                            .val(oFormattedDate.monthShort);
                } else
                    $(oDTP.element)
                        .find(".month .dtpicker-compValue")
                        .val(oFormattedDate.monthShort);
                ...
                $(oDTP.element)
                    .find(".year .dtpicker-compValue")
                    .val(oFormattedDate.yyyy);
                ...
                if (oDTP.settings.formatHumanDate) {
                    ...
                    if (
                        ...
                        if (oDTP.oData.bArrMatchFormat[4])
                            ...
                            sDate =
                                oFormattedDate.monthShort +
                                oDTP.settings.monthYearSeparator +
                                oFormattedDate.yyyy;
                        else if (oDTP.oData.bArrMatchFormat[6])
                            sDate =
                                oFormattedDate.month +
                                oDTP.settings.monthYearSeparator +
                                oFormattedDate.yyyy;
                        else if (oDTP.oData.bArrMatchFormat[7])
                            sDate =
            ...
            if (oDTP.oData.bTimeMode || oDTP.oData.bDateTimeMode) {
                ...
                if (oDTP.oData.bIs12Hour)
                    $(oDTP.element)
                        .find(".meridiem .dtpicker-compValue")
                        .val(oDTP.oData.sCurrentMeridiem);
                $(oDTP.element)
                    .find(".hour .dtpicker-compValue")
                    .val(oFormattedTime.hour);
                $(oDTP.element)
                    .find(".minutes .dtpicker-compValue")
                    .val(oFormattedTime.mm);
                $(oDTP.element)
                    .find(".seconds .dtpicker-compValue")
                    .val(oFormattedTime.ss);

                if (oDTP.settings.formatHumanDate) {
                    oDate = $.extend(oDate, oFormattedTime);
                } else {
                    var bShowSecondsTime =
                            oDTP.oData.bTimeMode &&
                            (oDTP.oData.bArrMatchFormat[0] ||
                                oDTP.oData.bArrMatchFormat[1]),
            ...
            if (oDTP.settings.formatHumanDate) {
                ...
                sDateTime = oDTP.settings.formatHumanDate.call(
                    oDTP,
                    oDate,
                    oDTP.settings.mode,
                    sFormat
        ...
        _setButtons: function () {
            var oDTP = this;
            $(oDTP.element)
                .find(".dtpicker-compButton")
                .removeClass("dtpicker-compButtonDisable")
                .addClass("dtpicker-compButtonEnable");
                ...
                if (oDTP.oData.bTimeMode) {
                    ...
                    if (
                        oDTP.oData.iCurrentHour + 1 >
                            oDTP.oData.dMaxValue.getHours() ||
                        (oDTP.oData.iCurrentHour + 1 ===
                            oDTP.oData.dMaxValue.getHours() &&
                            oDTP.oData.iCurrentMinutes >
                                oDTP.oData.dMaxValue.getMinutes())
                    )
                        $(oDTP.element)
                            .find(".hour .increment")
                            .removeClass("dtpicker-compButtonEnable")
                            .addClass("dtpicker-compButtonDisable");
            ...
            if (oDTP.oData.dMinValue !== null) {
                if (oDTP.oData.bTimeMode) {
                    ...
                    if (
                        oDTP.oData.iCurrentHour - 1 <
                            oDTP.oData.dMinValue.getHours() ||
                        (oDTP.oData.iCurrentHour - 1 ===
                            oDTP.oData.dMinValue.getHours() &&
                            oDTP.oData.iCurrentMinutes <
                                oDTP.oData.dMinValue.getMinutes())
                    )
                        $(oDTP.element)
                            .find(".hour .decrement")
                            .removeClass("dtpicker-compButtonEnable")
                ...
                if (
                    ...
                    if (oDTP.oData.dMaxValue !== null) {
                        if (oDTP.oData.bTimeMode) {
                            ...
                            if (
                                iTempHour > oDTP.oData.dMaxValue.getHours() ||
                                (iTempHour ===
                                    oDTP.oData.dMaxValue.getHours() &&
                                    iTempMinutes >
                                        oDTP.oData.dMaxValue.getMinutes())
                                ...
                                $(oDTP.element)
                                    .find(".meridiem .dtpicker-compButton")
                                    .removeClass("dtpicker-compButtonEnable")
                                    .addClass("dtpicker-compButtonDisable");
                        } else {
                            if (
                    ...
                    if (oDTP.oData.dMinValue !== null) {
                        if (oDTP.oData.bTimeMode) {
                            iTempMinutes = oDTP.oData.iCurrentMinutes;
                            if (
                                iTempHour < oDTP.oData.dMinValue.getHours() ||
                                (iTempHour ===
                                    oDTP.oData.dMinValue.getHours() &&
                                    iTempMinutes <
                                        oDTP.oData.dMinValue.getMinutes())
                ...
                if (oDTP.settings.isPopup) {
                    ...
                    if (oDTP.oData.oInputElement !== null) {
                        var iElemTop =
                                $(oDTP.oData.oInputElement).offset().top +
                                $(oDTP.oData.oInputElement).outerHeight(),
                            iElemLeft = $(oDTP.oData.oInputElement).offset()
                                .left,
                            iElemWidth = $(
                                oDTP.oData.oInputElement
                            ).outerWidth();
        ...
        _compareTime: function (dTime1, dTime2) {
            var iTimeMatch = 0;
            if (
                dTime1.getHours() === dTime2.getHours() &&
                dTime1.getMinutes() === dTime2.getMinutes()
            )
